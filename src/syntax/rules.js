...
const syntaxRuleDefinitions = [
...

  {
    ...
    scope: [
      ...
      "keyword.other.unit.percent.css",
      "meta.property-value.scss constant.numeric.css",
      "meta.property-value.media-query.scss constant.numeric.css",
    ],
...

  {
    ...
    scope: [
      "constant.language -constant.language.css -constant.language.scss -constant.language.less",
      "constant.other.php",
...

  {
    ...
    scope: [
      ...
      "meta.definition.variable.sass variable.sass",
      "variable.interpolation.scss",
      "variable.interpolation.sass",
      "variable.parameter.scss",
      "meta.at-rule.mixin.scss variable",
      "meta.at-rule.function.scss variable",
    ],
...

  {
    ...
    scope: [
      ...
      "meta.property-list.css variable.other.property-name",
      "meta.property-list.scss variable.other.property-name",
      "meta.property-value.css variable.other.property-name",
      "meta.property-value.scss variable.other.property-name",
      "meta.property-value.scss variable.scss",
      "meta.property-value.css variable.scss",
      "meta.property-list.scss meta.property-value.scss variable.scss",
      "variable.other.property-name.css",
    ],
    role: "sheetVariable",
  },

  {
    ...
    scope: [
      "meta.property-list.css meta.property-name support.type.property-name.css",
      "meta.property-list.scss meta.property-name support.type.property-name.scss",
      "meta.property-list.css meta.property-name support.type.property-name.scss",
      "meta.property-list.scss meta.property-name support.type.property-name.css",
      "meta.property-list.css meta.property-name.scss",
      "meta.property-list.scss meta.property-name.scss",
      "meta.property-list.css support.type.property-name.css",
      "meta.property-list.scss support.type.property-name.css",
      "meta.property-list.scss support.type.property-name.scss",
      "meta.property-list.media-query.scss meta.property-name.media-query.scss",
      "meta.property-list.media-query.scss support.type.property-name.media.css",
...

  {
    ...
    scope: [
      "entity.name.function -entity.name.function.scss -entity.name.function.keyframe.css -entity.name.function.keyframe.scss",
...

  {
    ...
    scope: [
      "support.type -support.type.property-name",
      "entity.name.type",
...

  {
    name: "HTML / JSX Tag",
    scope: [
      "entity.name.tag -entity.name.tag.css -entity.name.tag.scss -entity.name.tag.custom.css -entity.name.tag.custom.scss -entity.name.tag.reference.css -entity.name.tag.reference.scss -entity.name.tag.wildcard.css -entity.name.tag.wildcard.scss",
      "entity.name.tag.jsx",
      "entity.name.tag.tsx",
...

  {
    ...
    scope: [
      ...
      "meta.selector.scss entity.name.tag.css",
      "meta.rule.css entity.name.tag.css",
      "meta.rule.scss entity.name.tag.css",
      "meta.rules.css entity.name.tag.css",
      "meta.rules.scss entity.name.tag.css",
    ],
...

  {
    ...
    scope: [
      ...
      "meta.selector.scss entity.other.attribute-name.class.css",
      "meta.rule.css entity.other.attribute-name.class.css",
      "meta.rule.scss entity.other.attribute-name.class.css",
    ],
...

  {
    ...
    scope: [
      ...
      "meta.attribute-selector.scss entity.other.attribute-name.attribute.scss",
...

  {
    ...
    scope: [
      ...
      "meta.property-value.scss support.constant.property-value.css",
      "meta.property-value.css support.constant.property-value.scss",
      "meta.property-value.scss support.constant.property-value.scss",
      "meta.property-value.css support.constant.font-name",
      "meta.property-value.scss support.constant.font-name",
      "meta.property-value.media-query.scss support.constant.property-value.css",
      "support.constant.media-type",
      "support.constant.media",
      "constant.language.css",
      "constant.language.scss",
      "constant.language.less",
      "meta.property-value.css constant.language.css",
      "meta.property-value.scss constant.language.scss",
      "meta.property-list.media-query.scss meta.property-value.media-query.scss",
    ],
    role: "sheetValueKeyword",
  },

  {
    name: "CSS / SCSS Shorthand Value Identifier",
    scope: [
      "meta.property-list.scss meta.property-value.scss",
      "meta.property-list.css meta.property-value.css",
    ],
    role: "sheetValueProperty",
  },
...

  {
    ...
    scope: [
      ...
      "meta.at-rule.use.scss keyword.control.at-rule.use.scss",
      "meta.at-rule.include.scss keyword.control.at-rule.include.scss",
      "meta.at-rule.mixin.scss keyword.control.at-rule.mixin.scss",
      "meta.at-rule.media.scss keyword.control.at-rule.media.scss",
      "meta.at-rule.keyframes.scss keyword.control.at-rule.keyframes.scss",
      "meta.at-rule.import.scss keyword.control.at-rule.import.scss",
      "meta.at-rule.forward.scss keyword.control.at-rule.forward.scss",
      "meta.at-rule.function.scss keyword.control.at-rule.function.scss",
      "meta.at-rule.extend.scss keyword.control.at-rule.extend.scss",
  ...
  {
    name: "CSS Property — Tag Name Collision",
    scope: [
      "meta.property-list.css entity.name.tag.css",
      "meta.property-list.scss entity.name.tag.css",
      "meta.property-list.css entity.name.tag.scss",
      "meta.property-list.scss entity.name.tag.scss",
      "meta.property-list.css meta.property-name entity.name.tag.css",
      "meta.property-list.scss meta.property-name entity.name.tag.css",
    ],
    role: "sheetProperty",
  },

  {
    name: "CSS Value — Sub-Property Name",
    scope: [
      "meta.property-value.css support.type.property-name.css",
      "meta.property-value.scss support.type.property-name.css",
      "meta.property-value.css support.type.property-name.scss",
      "meta.property-value.scss support.type.property-name.scss",
      "meta.property-value.css invalid.deprecated.color.system.css",
      "meta.property-value.scss invalid.deprecated.color.system.css",
      "meta.property-value.css invalid.deprecated.color.system.scss",
      "meta.property-value.scss invalid.deprecated.color.system.scss",
      "meta.property-value.scss support.type.property-name.transition-sub.css",
      "meta.property-value.css support.type.property-name.transition-sub.css",
  ...
  {
    name: "CSS Attribute Selector Value",
    scope: [
      "meta.attribute-selector.scss string.quoted.double.attribute-value.scss",
      "meta.attribute-selector.scss string.quoted.single.attribute-value.scss",
      "meta.attribute-selector.css string.quoted.double.attribute-value.css",
      "meta.attribute-selector.css string.quoted.single.attribute-value.css",
    ],
    role: "sheetValueKeyword",
  },

  {
    name: "CSS Attribute Selector Brackets",
    scope: [
  ...
  {
    name: "CSS / SCSS Map Key",
    scope: ["support.type.map.key.scss", "support.type.map.key.sass"],
    role: "sheetProperty",
  },

  {
    name: "CSS / SCSS Operator",
    scope: [
      "source.css keyword.operator",
      "source.css.scss keyword.operator",
      "keyword.operator.css",
      "keyword.operator.css.scss",
  ...
  {
    name: "CSS / SCSS Custom Tag Selector",
    scope: [
      "entity.name.tag.custom.scss",
      "entity.name.tag.custom.css",
      "meta.property-list.scss entity.name.tag.custom.css",
      "meta.property-list.scss entity.name.tag.custom.scss",
...

  {
    ...
    scope: [
      ...
      "meta.property-list.scss entity.name.tag.reference.css",
    ],
    role: "sheetSelectorPseudo",
  },

  {
    name: "CSS / SCSS Combinator",
    scope: [
  ...
  {
    name: "CSS / SCSS Module Reference",
    scope: [
  ...
  {
    name: "CSS / SCSS Parameter Name",
    scope: [
      "variable.parameter.url.scss",
      "variable.parameter.style-name.css",
      "variable.parameter.style-name.scss",
    ],
    role: "sheetValueIdentifier",
  },

  {
    name: "CSS / SCSS Pseudo Selector Keyword",
    scope: ["constant.other.scss", "constant.other.css"],
    role: "sheetValueKeyword",
  },
];
